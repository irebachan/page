...
this.TN_gameMap = TN_gameMap;
};
 

//$gameSystem.TN_gameMap
...
Game_System.prototype.onBeforeSave = function() {
    ...
    $gameSystem.TN_gameMap = $gameMap._events;
    //ここで　特定イベントの配列だけ削除するようなこと　できんかな？
    let copy = JSON.parse(JSON.stringify($gameSystem.TN_gameMap));
    copy.splice(21, 16); // ID[21]からID[49] までのイベントは保存しなくていい……という……
    console.log(copy)
    //$gameMap._events = [];
    $gameMap._events = copy;
};
...
Scene_Save.prototype.onSavefileOk = function() {
    ...
    $gameMap._events = $gameSystem.TN_gameMap;
};
